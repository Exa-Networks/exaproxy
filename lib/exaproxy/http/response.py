...
#		<center>
#			<div style="padding:15; color: #FFFFFF; background: #FF0000; font-size: 40px; font-family: verdana,sans-serif,arial; font-weight: bold; border-bottom: solid 1px #A0A0A0;">
#				%s
#				<br>
...
#
#	def _fetch (self):
#		yield _http(self.code,_html(self.title,self.body))
#		yield None
