...
class _Logger (object):
	...
	def __init__ (self):
		...
		self.debug_supervisor = False
		self.debug_daemon = False
		self.debug_server = False
		self.debug_client = False
		self.debug_manager = False
		self.debug_worker = False
	...
	def debug (self,message,source='',level='DEBUG'):
		for line in message.split('\n'):
			...
			elif self.level >= syslog.LOG_DEBUG:
	...
	def info (self,message,source='',level='INFO'):
		for line in message.split('\n'):
			...
			elif self.level >= syslog.LOG_INFO:
				print self._prefixed(level,source,line)
				sys.stdout.flush()
	...
	def warning (self,message,source='',level='WARNING'):
		for line in message.split('\n'):
			...
			elif self.level >= syslog.LOG_WARNING:
				print self._prefixed(level,source,line)
				sys.stdout.flush()
	...
	def error (self,message,source='',level='ERROR'):
		for line in message.split('\n'):
			...
			elif self.level >= syslog.LOG_ERR:
				print self._prefixed(level,source,line)
				sys.stdout.flush()
	...
	def critical (self,message,source='',level='CRITICAL'):
		for line in message.split('\n'):
			...
			elif self.level >= syslog.LOG_CRIT:
				print self._prefixed(level,source,line)
				sys.stdout.flush()
